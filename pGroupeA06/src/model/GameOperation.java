...
//	public static void skipMilliseconds(int seconds,StackPane firstPane, StackPane nextPane ) {
//		
//		PauseTransition pause1 = new PauseTransition(Duration.seconds(seconds));
//		PauseTransition pause2 = new PauseTransition(Duration.seconds(seconds));
